...
Footer.defaultProps = {
  ...
  link7: 'Book Appointment',
  link5: 'Privacy Policy',
  link8: 'Blog',
  action1: 'Subscribe to Newsletter',
  content3:
    'Disclaimer: The information provided on this site is for general informational purposes only and should not be considered medical advice.',
  link4: 'FAQs',
  logoSrc: 'https://presentation-website-assets.teleporthq.io/logos/logo.png',
  cookiesLink: '/cookie-policy',
  content2: '&copy; 2023 Spine Clinic. All rights reserved.',
  link9: 'Testimonials',
  link6: 'Terms of Use',
  logoAlt: 'Spine Clinic Logo',
  link1: 'Home',
