...
Pricing.defaultProps = {
  ...
  plan3Feature1: 'Everything in Standard Plan',
  plan2Feature3: 'Follow-up appointments',
  plan1Price1: '$200/yr',
  plan2: 'Standard Plan',
  plan2Feature21: 'Feature text goes here',
  plan2Action1: 'Get started',
  plan3Feature2: 'MRI scan included',
  content1: 'Choose the perfect plan for you',
  plan2Feature1: 'Everything in Basic Plan',
  ...
  plan1Feature3: 'Treatment plan',
  plan1Yearly: '$999/year',
  plan1Feature1: 'Initial consultation',
  plan3Feature3: 'Surgical options available',
